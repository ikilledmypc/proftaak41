...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2014 at 07:47 PM
...
-- Database: `pt4`
--
CREATE DATABASE IF NOT EXISTS `pt4` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pt4`;
...
(2, NULL, 'INGB456789072372736', 0, '0'),
...
ALTER TABLE `order_photo_product`
  ...
  ADD CONSTRAINT `photo_photoorderproduct` FOREIGN KEY (`photoID`) REFERENCES `photo` (`photoID`);
